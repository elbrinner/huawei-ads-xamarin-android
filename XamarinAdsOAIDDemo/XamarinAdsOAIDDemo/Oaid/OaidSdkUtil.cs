...
using Com.Huawei.Hms.Ads.Identifier;
using Java.IO;
    ...
    public class OaidSdkUtil
    {
        ...
        public static void GetOaid(Context context, OaidCallback callback)
        {
            ...
            try
            {
                ...
                Log.Info(TAG, "AdvertisingIdClient.GetAdvertisingIdInfo function callet successfully.");
            ...
            {
                Log.Error(TAG, "getAdvertisingIdInfo IOException");
                callback.OnFail("getAdvertisingIdInfo IOException:" + ex.Message);
            }
        }
