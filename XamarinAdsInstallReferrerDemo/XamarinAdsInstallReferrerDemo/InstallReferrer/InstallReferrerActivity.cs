...
namespace XamarinAdsInstallReferrerDemo.InstallReferrer
{
    ...
    public class InstallReferrerActivity : BaseActivity,InstallReferrerCallback
    {
        ...
        protected class Runnable : Java.Lang.Object, IRunnable
        {
            ...
            public void Run()
            {
                installReferrerActivity.mReferrerTv.Text = installReferrer;
                installReferrerActivity.mClickTimeTv.Text = clickTimestamp.ToString();
                installReferrerActivity.mInstallTimeTv.Text = installTimestamp.ToString();
            }
        }
        ...
        private void GetInstallReferrer()
        {
            ...
            Log.Info(TAG, "getInstallReferrer mode=" + mode);
