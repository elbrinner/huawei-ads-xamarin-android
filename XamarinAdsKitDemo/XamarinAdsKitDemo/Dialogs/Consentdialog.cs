...
namespace XamarinAdsKitDemo.Dialogs
{
    public class ConsentDialog : Dialog,View.IOnClickListener
    {
        ...
        private IList<AdProvider> mAdProviders;
        ...
        */
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            titleTv.Text = mContext.GetString(Resource.String.consent_title);
        ...
        private void AddInitButtonAndLinkClick(View consentDialogView)
        {
            ...
            string initText = mContext.GetString(Resource.String.consent_init_text);
            ...
            int initTouchHereStart = mContext.Resources.GetInteger(Resource.Integer.init_here_start);
            int initTouchHereEnd = mContext.Resources.GetInteger(Resource.Integer.init_here_end);
        ...
        private void AddMoreInfoButtonAndLinkClick(View consentDialogView)
        {
            ...
            string moreInfoText = mContext.Resources.GetString(Resource.String.consent_more_info_text);
            ...
            int moreInfoTouchHereStart = mContext.Resources.GetInteger(Resource.Integer.more_info_here_start);
            int moreInfoTouchHereEnd = mContext.Resources.GetInteger(Resource.Integer.more_info_here_end);
        ...
        private void ShowPartnersListInfo()
        {
            ...
            partnersListTv.Text = "";
            IList<AdProvider> learnAdProviders = mAdProviders;
