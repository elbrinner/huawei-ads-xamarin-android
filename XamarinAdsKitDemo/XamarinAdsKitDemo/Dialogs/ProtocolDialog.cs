...
namespace XamarinAdsKitDemo.Dialogs
{
    public class ProtocolDialog : Dialog,IDialogInterfaceOnClickListener
    {
        ...
        private ProtocolDialogCallback dialogCallback;
        ...
        public void SetCallback(ProtocolDialogCallback callback) { dialogCallback = callback; }
        ...
        private void InitClickableSpan()
        {
            ...
            string privacyInfoText = mContext.GetString(Resource.String.protocol_content_text);
            ...
            int privacyTouchHereStart = mContext.Resources.GetInteger(Resource.Integer.privacy_start);
            int privacyTouchHereEnd = mContext.Resources.GetInteger(Resource.Integer.privacy_end);
            int personalizedTouchHereStart = mContext.Resources.GetInteger(Resource.Integer.personalized_start);
            int personalizedTouchHereEnd = mContext.Resources.GetInteger(Resource.Integer.personalized_end);
        ...
        {
            ISharedPreferences sharedPreferences = mContext.GetSharedPreferences(AdsConstant.SP_NAME, FileCreationMode.Private);
        ...
        private void StartActivity(string action)
        {
            ...
            PackageManager pkgMng = mContext.PackageManager;
            if (pkgMng != null)
            {
        ...
        private void AddAlertView()
        {
            ...
            builder.SetTitle(mContext.GetString(Resource.String.alert_title));
            builder.SetMessage(mContext.GetString(Resource.String.alert_content));
            builder.SetPositiveButton(mContext.GetString(Resource.String.alert_confirm), this);
            builder.Show();
        }
