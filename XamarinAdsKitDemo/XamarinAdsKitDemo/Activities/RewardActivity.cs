...
namespace XamarinAdsKitDemo.Activities
{
    ...
    public class RewardActivity : BaseActivity,View.IOnClickListener
    {
        private const int PLUS_SCORE = 1;
        ...
        {
            reStartButton = FindViewById<Button>(Resource.Id.play_button);
           ...
           if(rewardedAd == null)
            {
                ...
                //rewardedAd = RewardAd.CreateRewardAdInstance(this);
        ...
        public void OnClick(View v)
        {
            switch (v.Id)
            {
                case Resource.Id.show_video_button:
                    RewardAdShow();
                    break;
                case Resource.Id.play_button:
                    Play();
                    break;
                default:
                    break;
