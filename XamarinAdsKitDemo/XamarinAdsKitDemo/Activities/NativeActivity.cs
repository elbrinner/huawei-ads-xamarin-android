...
namespace XamarinAdsKitDemo.Activities
{
    ...
    public class NativeActivity : BaseActivity, NativeAd.INativeAdLoadedListener,IDislikeAdListener
    {
        ...
        {
            #region Edit this part some functions are not available
            ...
            //nativeAdLoader.LoadAds(new AdParam.Builder().Build(), 2);
            //Log.Info(TAG, "NativeAdLoader.LoadAds called successfully.");
        ...
        protected class DislikeAdReason : Java.Lang.Object, IDislikeAdReason
        {
        ...
        public void OnNativeAdLoaded(NativeAd nativeAd)
        {
            ...
            nativeAd.DislikeAd(new DislikeAdReason());
            Log.Info(TAG, "Called DislikeAd successfully.");
