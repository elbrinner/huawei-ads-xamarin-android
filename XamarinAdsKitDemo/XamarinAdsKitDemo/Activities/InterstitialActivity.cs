...
namespace XamarinAdsKitDemo.Activities
{
    ...
    public class InterstitialActivity : BaseActivity,View.IOnClickListener
    {
        private static readonly string TAG = /*Type.GetType(typeof(InterstitialActivity).Name).ToString()*/ "fs";
